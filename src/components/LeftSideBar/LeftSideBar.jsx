  ...
  const addChat = async () => {
    ...
    try {
      ...
      await updateDoc(doc(chatsRef, user.id), {
        chatsData: arrayUnion(newChatEntryForOtherUser)
      });

      await updateDoc(doc(chatsRef, userData.id), {
        chatsData: arrayUnion(newChatEntryForMe)
      });
      ...
      setChatUser(finalChatData);
      setShowSearch(false);
      setChatVisible(true);

      toast.success("Friend added to Chat List");
    } catch (error) {
